...
ALTER TABLE passports ADD CONSTRAINT fk_passports_client_tenant FOREIGN KEY (client_id) REFERENCES clients(id) NOT VALID;
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_passport FOREIGN KEY (passport_id) REFERENCES passports(id) NOT VALID;
ALTER TABLE alerts ADD CONSTRAINT fk_alerts_client FOREIGN KEY (client_id) REFERENCES clients(id) NOT VALID;
ALTER TABLE evidence_items ADD CONSTRAINT fk_evidence_items_passport FOREIGN KEY (asset_id) REFERENCES passports(id) NOT VALID;
ALTER TABLE trust_observations ADD CONSTRAINT fk_trust_observations_passport FOREIGN KEY (passport_id) REFERENCES passports(id) NOT VALID;
ALTER TABLE trust_observation_changes ADD CONSTRAINT fk_trust_observation_changes_observation FOREIGN KEY (observation_id) REFERENCES trust_observations(id) NOT VALID;
ALTER TABLE collector_results ADD CONSTRAINT fk_collector_results_job FOREIGN KEY (job_id) REFERENCES collector_jobs(id) NOT VALID;
ALTER TABLE remediation_tasks ADD CONSTRAINT fk_remediation_tasks_alert FOREIGN KEY (alert_id) REFERENCES alerts(id) NOT VALID;
ALTER TABLE remediation_verifications ADD CONSTRAINT fk_remediation_verifications_task FOREIGN KEY (task_id) REFERENCES remediation_tasks(id) NOT VALID;
ALTER TABLE agent_logs ADD CONSTRAINT fk_agent_logs_job FOREIGN KEY (job_id) REFERENCES agent_jobs(id) NOT VALID;

CREATE UNIQUE INDEX IF NOT EXISTS uq_trust_observations_idempotency ON trust_observations (tenant_id, passport_id, idempotency_key) WHERE idempotency_key IS NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS uq_collector_jobs_idempotency ON collector_jobs (tenant_id, idempotency_key);
